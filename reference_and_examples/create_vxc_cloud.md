...
| externalId | M | String | on the top request level the Order reference ID of SSS |  |
...
| implementServiceOver | M | String | implement service over ex. new customer port | Specify type of service implementation: \-New customer port \-Existing customer port |
...
| cloudProvider | O | String | Specify the cloud provider. Ex. Oracle | Used to specify the provider of the cloud. (require if connectXSolution \= cloud) |
| networkZone | O | String | Specify the network zone of the cloud. Ex. 1 | Used to specify the zone of the cloud. (require if connectXSolution \= cloud) |
| awsOwnerAccountID | O | String |  | Mandatory for AWS |
| awsAccountID | O | String |  | AWS AccountID |
| awsConnectionId | O | String |  |  |
| cloudVXCName | O | String |  | AWS, GCP, Azure will use this |
